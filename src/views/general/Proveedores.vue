                    ...
                    <div class="col-12 col-sm-12 mt-4">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr v-for="(item, indice) in datos" :key="item.id">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button class="btn btn-warning" @click="editar(item.id)"><i class="fas fa-pencil"></i></button>
                                                <button class="btn" :class="item.estado ? 'btn-danger':'btn-success'" @click="estado(item.id)"><i class="fa-solid fa-retweet"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                ...
                                <li class="page-item" :class="{'active' : item == paginacion.pagina}" v-for="(item, indice) in paginacion.total" :key="indice"><button type="button" class="page-link" @click="paginaCambio(item)">{{item}}</button>
                                </li>
                                <li class="page-item"
